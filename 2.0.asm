...
MOV CX,0AH ;longuitud del resultado en su parte entera
...
MOV CX,0AH ;longuitud del resultado en su parte decimalexceptuando el primer decimal
...
MOV num_res[DI],07h             ;reemplazar ceros por 20h (espacio vacio)
INC DI
...
MOV DI,09h                      ;iniciamos el DI en el digito mas a la derecha en los decimales
