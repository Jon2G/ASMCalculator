...
;-----------------------------------------------------------------------------------------------------------   
	...
	db "Para realizar una operaci",0A2h,"n (+,-,x,/) ingrese el primer n",0A3h,"mero,",13
    db "la operaci",0A2h,"n que desea realizar, el segundo n",0A3h,"mero y presione el",13                        ;
	db "signo igual (=).",13                 ;
...
end_cpy_d:                                                                      ;Etiqueta 'end_cpy_d'
	;PAUSA
	MOV decimales_res[00h],07H                                                  ;Asigna 30H a decimales_res[12h]
	MOV decimales_res[01h],30H                                                  ;Asigna 30H a decimales_res[13h]
