...
;-----------------------------------------------------------------------------------------------------------   
	...
	db "para navegar",13                                                        ;                                                     
	db "Para ingresar las operaciones digite:",13                               ;
	db "El primer operando seguido de un operador y el segundo operando",13     ;
	db "(Ejemplo: -9x-10) al finalizar oprima '='",13                           ;
