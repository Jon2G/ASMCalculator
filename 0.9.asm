...
.data                             
    ...
    temp equ 00h 
     ;db "                    ______  _____ _____ __  __ ______ ",13,
     ...
     caratula_str db "   Garc",0A1h,"a Ponce Javier (El compa",0A4h,"ero que si estudia)$"
    seleccion db 00h
...
Interfaz proc near        
        ...
        ;Marco 0Ah,27h,13h,01h
        ;Marco alto,ancho,X,Y
