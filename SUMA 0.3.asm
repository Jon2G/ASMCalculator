...
.data
num1          db 0,10 dup('$')    
decimales_1   db 0,10 dup('$')   

num2          db 0,10 dup('$')   
decimales_2   db 11 dup(0)   

num_res       db 11 dup('$')  
decimales_Res db 11 dup(0) 

Acarreo_ParaEntero db 0 
posicion_ultimo_entero dw 0
display_str  db "105.578+11.5",'$',14 DUP(0)
.stack 
.code
mov ax,@data
mov ds,ax
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ;Hacer coincidir los fines de cadena para los enteros
...
;;IMPRIMIR RESULTADO
;;Revisar que el primer numero no sea 0
jmp imprime_res_Suma
elimina_primer_cero:
mov num_res[0],08h ;caracter de retroceso   
;;
imprime_res_Suma:                  
cmp num_res[0],30h
JE elimina_primer_cero
