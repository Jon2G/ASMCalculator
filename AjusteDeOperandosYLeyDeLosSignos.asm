...
.stack
.data
 display_str  db "-+-+-+-+-+-+-+-12.98-+-+-",0F6h,"-+---+-677.981",14 DUP(0),'$'
    ...
    CMP num1_signo,Al 
        ...
        signos_iguales:
            ...
            CMP operacion,'x'      ;-*- => (+) le correponde a la multiplicacion
                JE iguales_mult    ;+*+=>  (+) le correponde a la multiplicacion
            CMP operacion,0F6h     ;-/- => (+) le correponde a la division
                JE iguales_mult        ;+/+ => (+) le correponde a la division        
...
;------------------------------------------------------------------
    ...
    pos_neg:
            CMP operacion,'+'       ;+1 - -2 => (1+2) le corresponde a la suma y no habra signo
                JE suma_pos        
